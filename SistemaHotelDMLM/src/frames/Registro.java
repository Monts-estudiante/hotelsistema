...
public class Registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonRegresa.setText("Regresar a Principal");
        jButtonRegresa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonRegresaActionPerformed(evt);
            }
        });
...
//        JOptionPane.showConfirmDialog(this,  personas(nombre, ciudad, fec, res, lim, habitacion));
    ...
    private void jButtonRegresaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegresaActionPerformed
        // TODO add your handling code here:
        principal llamar = new principal();
        llamar.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_jButtonRegresaActionPerformed
